class MatchesController < ApplicationController
 	...
 	def create
      ...
      puts params,"THIS IS THE PARAMS BEING PASSED"
      puts @profile, "THIS IS THE PROFILES INFO"
      # NEED REDIRECT TO CHAMPION_MASTERS GRAPH TO LET USERS KNOW THEY HAVE NO MATCHES PLAYED THIS 2016 SEASON WITH THAT PARTICULAR CHAMPION###############################
      if @match_history['totalGames']  == 0
        ...
        # THIS IS WHERE IT WILL GRAPH THE MATCHES PLAYED BY THIS CHAMPION THAT HAS A RANK AND MATCHES PLAYED #################################################
        else
