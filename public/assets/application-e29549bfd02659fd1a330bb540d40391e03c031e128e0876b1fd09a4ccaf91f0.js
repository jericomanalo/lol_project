...
(function(D, aa) {
  ...
  U = {
    ...
    chart: {
      ...
      plotBorderColor: "rgb(142, 49, 170)",
      resetZoomButton: {
        theme: {
          zIndex: 20
        },
...
$(document).ready(function (){
            ...
            $("#name_container li").click(function (){
              ...
              if(selected >= 6){
                console.log("SELECTED > 6", selected);
                offset = 0;
                set_index = $(this).index() - 6;
                selected =  $("#name_container li").eq(set_index).attr("id");
              } else{
              ...
              $('#splash_container').scrollTo(document.getElementById(champion_id), 800, {offset: offset});
              // $('#name_container ul').scrollTo(document.getElementById(selected), 800);
              $('#name_container .scroll').scrollTo(document.getElementById(selected), 800);
              return false;
            });
